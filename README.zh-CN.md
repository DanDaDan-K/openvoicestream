...
当前发布版本在双语路径使用 Matcha/Vocos，在仅英文部署使用 Kokoro，在需要声音克隆或 52 语言 TTS 时使用 Qwen3-TTS，以及为轻量级多语言纯 TTS 路径使用 MOSS-TTS-Nano。下表中的 RTF 数字在可获得处取自 2026-05-18 的基准测试运行；未使用的研究模型作为历史背景保留。

...
The /v2v server-loop gate (server/main.py: ``OVS_V2V_SERVER_LOOP``) and the
...
SLV half (the agent half was fixed in ovs_agent/config.py).
"""

import pytest

from server.main import _env_truthy
